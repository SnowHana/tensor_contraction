...
set( test_tensor_TESTS [==[at() multiple writes are reflected correctly]==] [==[Tensor throws on mismatched size]==] [==[Tensor construction and shape check - bigger dimensions]==] [==[at() sequential row-major traversal equals flat order]==] [==[at() const overload returns const ref (read-only)]==] [==[at() row-major mapping on 3D]==] [==[Tensor out-of-range coordinate throws]==] [==[Tensor construction and shape check]==] [==[at() stress small grid: all coordinates valid, neighbors distinct]==] [==[at() boundary indices on 1D and 2D]==] [==[at() end-to-end: fill via at() then verify]==] [==[Tensor element access with at()]==] [==[at() rank mismatch and index OOB]==])
